...
; Abstract:
;
;   This module implements a kernel for computing the error
...
; Routine Description:
;
;   This routine implements a vectorized kernel for the error
;   function.
;
; Arguments:
;
...
LComputeErf4x8Loop:
        ...
        vmovups      YMMWORD PTR 32+ErfKernelFrame.ErfBuffer0[rsp],ymm5
        vmovups      YMMWORD PTR 64+ErfKernelFrame.ErfBuffer0[rsp],ymm6
        vmovups      YMMWORD PTR 96+ErfKernelFrame.ErfBuffer0[rsp],ymm7
        ...
        vmovups      YMMWORD PTR 32+ErfKernelFrame.ErfBuffer1[rsp],ymm9
        vmovups      YMMWORD PTR 64+ErfKernelFrame.ErfBuffer1[rsp],ymm10
        vmovups      YMMWORD PTR 96+ErfKernelFrame.ErfBuffer1[rsp],ymm11
...
LBiggerNumbers:
        ...
        vmovups YMMWORD PTR 32[rdx],ymm1
